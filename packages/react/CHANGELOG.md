...
- Updated dependencies [58a8d91]
- Updated dependencies [99c0903]
- Updated dependencies [3ccff80]
  - @vroomchart/core-wasm@0.18.0
...
- f7585d4: Add footprints: circular badges marking executed trades above the bar they filled in
  ...
  Panning, zooming, an axis drag, or raising the crosshair on touch all fire a `'hide'`, so a tooltip is never left anchored to a bar that has moved and you don't need a gesture listener of your own to take it down.

### Patch Changes

- Updated dependencies [f7585d4]
  - @vroomchart/core-wasm@0.16.0
...
- Updated dependencies [8a7f04d]
  - @vroomchart/core-wasm@0.14.0
