...
relies on these peer dependencies. Install them if your app doesn't already have
them:
...
| Package | Version |
| --- | --- |
| [`@shopify/react-native-skia`](https://shopify.github.io/react-native-skia/) | `>= 2.11.0` |
...
| [`react-native-worklets`](https://docs.swmansion.com/react-native-worklets/) | `>= 0.7.0` |
